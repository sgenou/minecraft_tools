...
foreach ($merchants_list as $merchants_list_element) {
  ...
  echo 'execute @e[type=Squid,name=' . $merchants_list_element . '] ~ ~ ~ blockdata ~ ~ ~ {Text1:"{\"text\":\" \",\"color\":\"dark_red\",\"bold\":\"true\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @a ' . $merchants_list_element . ' 1\"}}",Text2:"{\"text\":\"|\",\"color\":\"dark_red\",\"bold\":\"true\"}",Text3:"{\"text\":\"V\",\"color\":\"dark_red\",\"bold\":\"true\"}",Text4:"{\"text\":\"\",\"color\":\"red\"}",id:"Sign"}';
}
